...
In this project, I compared performance of Opencv-SGBM and ELAS two disparity computing algorithms, and choose the later one`s result for dense recon, using PCL Delaunay method to create 3D mesh.
